...
/* user/show.html.twig */
class __TwigTemplate_f67ddb3f0d35ba8c74d40f6ac8708ca1 extends Template
{
    ...
    <a href=\"";
        // line 35
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 35, $this->source); })()), "id", [], "any", false, false, false, 35)]), "html", null, true);
        yield "\">edit</a>
...
{% endblock %}
", "user/show.html.twig", "/Users/miniemile/Desktop/BUREAU/FOAD_20_12_24/foadBiblio/templates/user/show.html.twig");
    }
}
