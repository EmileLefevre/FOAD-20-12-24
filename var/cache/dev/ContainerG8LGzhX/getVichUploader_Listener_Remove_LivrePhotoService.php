 ...
 */
class getVichUploader_Listener_Remove_LivrePhotoService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.livre_photo' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.livre_photo'])) {
            return $container->privates['vich_uploader.listener.remove.livre_photo'];
        }

        return $container->privates['vich_uploader.listener.remove.livre_photo'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('livre_photo', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
